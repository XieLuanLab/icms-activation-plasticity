...
%                 'Z:\xl_stimulation\ICMS92\9-25-23\PlanarTrialsG8\SessionMetrics.mat'};
    files2Load = {'Z:\ICMS92\9-6-23\PlanarTrialsG8\SessionMetrics.mat';...
                'Z:\ICMS92\9-8-23\PlanarTrialsG8\SessionMetrics.mat';...
                'Z:\ICMS92\9-12-23\PlanarTrialsG8\SessionMetrics.mat';...
                'Z:\ICMS92\9-14-23\PlanarTrialsG8\SessionMetrics.mat';...
                'Z:\ICMS92\9-19-23\PlanarTrialsG8\SessionMetrics.mat';...
                'Z:\ICMS92\9-21-23\PlanarTrialsG8\SessionMetrics.mat';...
                'Z:\ICMS92\9-25-23\PlanarTrialsG8\SessionMetrics.mat'};
...
%                       'Z:\xl_stimulation\ICMS98\11-17-23\PlanarTrialsG8\SessionMetrics.mat'};
      files2Load = {'Z:\ICMS98\10-20-23\PlanarTrialsG8\SessionMetrics.mat';...
                      'Z:\ICMS98\10-24-23\PlanarTrialsG8\SessionMetrics.mat';...
                      'Z:\ICMS98\10-26-23\PlanarTrialsG8\SessionMetrics.mat';...
                      'Z:\ICMS98\10-31-23\PlanarTrialsG8\SessionMetrics.mat';...
                      'Z:\ICMS98\11-2-23\PlanarTrialsG8\SessionMetrics.mat';...
                      'Z:\ICMS98\11-7-23\PlanarTrialsG8\SessionMetrics.mat';...
                      'Z:\ICMS98\11-17-23\PlanarTrialsG8\SessionMetrics.mat'};
        refInd = 5;
        minSetCnt = 3;
                % minSetCnt = 1;
...
%                       'Z:\xl_stimulation\ICMS93\9-26-23\PlanarTrialsG8\SessionMetrics.mat'};
      files2Load = {'Z:\ICMS93\8-30-23\PlanarTrialsG8\SessionMetrics.mat';...
                      'Z:\ICMS93\9-6-23\PlanarTrialsG8\SessionMetrics.mat';...
                      'Z:\ICMS93\9-14-23\PlanarTrialsG8\SessionMetrics.mat';...
                      'Z:\ICMS93\9-22-23\PlanarTrialsG8\SessionMetrics.mat';...
                      'Z:\ICMS93\9-26-23\PlanarTrialsG8\SessionMetrics.mat'};
        refInd = 2;
        minSetCnt = 3;
                % minSetCnt = 1;
...
%         daysTrained = [6,21,26,27,34];   
    ...
    files2Load = strrep(files2Load, 'Z:\xl_stimulation', 'S:\'); % robin edit
    files2Load = strrep(files2Load, 'Z:\', 'S:\'); % robin edit
    ...
    for f = 1:numel(files2Load)
        ...
        for r1 = 1:numel(curRegions) % iterate through all regions and find subsequent regions that overlap
            if(curProc(r1)==0) % only process valid regions that have not been processed yet
                ...
                % last two sessions for the ROI (week 54)
...
%     subset2 = nonmon;
    for t = 1:10
        ...
        SEM = std(metricTrend,[],1,'omitnan')/sqrt(length(metricTrend));               % Standard Error
...
svTxt
        ...
        % end
        for s = 1:size(metricTrendInv,2)
            p = ranksum(metricTrendInv(:,s),metricTrend(:,s))
            if(p<0.001)
...
%         close(curFig)
     ...
     for t = 1:6
        ...
        % metricTrend2 = randsample(metricTrend2,100);
