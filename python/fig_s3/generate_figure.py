...
Panels:
  A. PCA example (PC2 vs PC1, stim vs non-stim)
  B. Modulation z-score of all modulated cells over weeks
  C. Time to max firing rate of all modulated cells over weeks
  D. Modulation at each session's detection threshold
...
from utils.config import (RAW_DF_PATH, STIM_NONSTIM_PATH,
