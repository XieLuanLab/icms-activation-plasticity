"""Figure S9 -- Pop coupling panels (700ms, 120ms, control).
...
def load_behav_pc(pkl_pattern, df_mod, animals=ANIMALS_BEHAV):
...
def main():
    ...
    # ICMS83 is excluded from the 700ms panel (no 700ms pop-coupling data),
    # matching published Fig S9A (PL n=446/763); it is included in the 120ms
    # panel below (Fig S9B) and in the main Fig 6 pop-coupling panel.
    print('=== Behavioral 700ms ===')
    groups_700 = load_behav_pc('{}_pop_coupling.pkl', df_mod,
                               animals=EXPERIMENTAL_ANIMALS)
